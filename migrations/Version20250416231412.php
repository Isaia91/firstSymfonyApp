 ...
 */
final class Version20250416231412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tag_book_mark (book_mark_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_6EDE835ED1B0D9BD (book_mark_id), INDEX IDX_6EDE835EBAD26311 (tag_id), PRIMARY KEY(book_mark_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
